...
const connectDB = async () => {
  try {
    const mongoURI =
      process.env.MONGO_URI || "mongodb://localhost:27017/quizlingo";
...
// Dữ liệu chủ đề triết học Mác-LêNin
const defaultTopics = [
  {
    name: "duy_vat_bien_chung",
    title: "Duy vật biện chứng",
    description:
      "Phương pháp luận triết học Mác-xít về quy luật biến đổi và phát triển của thế giới",
    keywords: [
      "duy vật",
      "biện chứng",
      "quy luật",
  ...
  },
  {
    ...
    description:
      "Quan niệm duy vật về lịch sử xã hội và quy luật phát triển xã hội",
    keywords: [
      "lịch sử",
      "xã hội",
      "hình thái",
  ...
  },
  {
    ...
    description:
      "Lý thuyết về quá trình nhận thức thế giới và vai trò của thực tiễn trong nhận thức",
    keywords: [
      "nhận thức",
      "thực tiễn",
      "chân lý",
  ...
  },
  {
    ...
    description:
      "Quy luật thống nhất và đấu tranh của các mặt đối lập trong sự vật",
    keywords: [
      "mâu thuẫn",
      "đối lập",
      "thống nhất",
  ...
  },
  {
    ...
    description:
      "Quy luật về sự phát triển theo hình xoắn ốc của sự vật, hiện tượng",
    keywords: [
      "phủ định",
      "khẳng định",
      "xoắn ốc",
  ...
  },
  {
    ...
    description:
      "Quan niệm Mác-xít về bản chất con người và mối quan hệ cá nhân - xã hội",
    keywords: [
      "con người",
      "bản chất",
      "xã hội",
  ...
  },
  {
    ...
    title: "Ý thức xã hội",
    description:
      "Lý thuyết về ý thức xã hội, các hình thái ý thức xã hội và vai trò của chúng",
    keywords: [
      "ý thức",
      "tồn tại",
      "hình thái",
  ...
  },
  {
    ...
    description:
      "Lý thuyết về sự hình thành giai cấp và đấu tranh giai cấp trong xã hội",
    keywords: [
      "giai cấp",
      "đấu tranh",
      "vô sản",
  ...
  },
  {
    ...
    description:
      "Quan niệm về nhà nước, cách mạng xã hội và sự chuyển đổi xã hội",
    keywords: [
      "nhà nước",
      "cách mạng",
      "chuyên chính",
...
const seedTopics = async () => {
  try {
    console.log("🌱 Đang seed dữ liệu chủ đề triết học Mác-LêNin...");
...
const main = async () => {
  try {
    await connectDB();
    await seedTopics();
    console.log("\n🎉 Hoàn thành seed dữ liệu triết học Mác-LêNin!");
    process.exit(0);
  } catch (error) {
