...
const lessonSchema = new mongoose.Schema({
  ...
  type: {
    ...
    enum: {
      ...
      message:
        "Loại bài học phải là multiple_choice, text_input hoặc audio_input",
    },
  ...
  topic: {
    ...
    enum: {
      ...
      message:
        "Chủ đề phải là một trong: travel, business, daily_life, education, food",
    },
  ...
  skill: {
    ...
    enum: {
      ...
      message:
        "Kỹ năng phải là vocabulary, reading, writing, listening, hoặc speaking",
    },
...
lessonSchema.pre("validate", function (next) {
  if (
    ...
    !["vocabulary", "reading", "listening"].includes(this.skill)
  ) {
    next(
      new Error(
